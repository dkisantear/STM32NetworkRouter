#!/bin/bash
# Complete setup script - Run this ON the Raspberry Pi
# Username: pi5
# Either copy-paste this entire script, or transfer and run it
...
API_URL = "https://blue-desert-0c2a27e1e.3.azurestaticapps.net/api/gateway-status"
HEARTBEAT_INTERVAL = 60  # QUOTA-EFFICIENT: 60 seconds (~43k/month vs 172k/month)
heartbeat_count = 0
