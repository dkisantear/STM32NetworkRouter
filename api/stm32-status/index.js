...
const TABLE_NAME = "GatewayStatus";  // Reuse same table as gateway-status
const PARTITION_KEY = "stm32";  // Different partition for STM32 devices
const TIMEOUT_MS = 90 * 1000;  // 90 seconds timeout for auto-offline
