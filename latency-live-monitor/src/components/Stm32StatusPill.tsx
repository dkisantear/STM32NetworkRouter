...
export const Stm32StatusPill = () => {
  const { status, lastUpdated, loading, error } = useStm32Status();
  ...
  const getStatusGlow = (): string => {
    ...
    if (status === 'online') return 'shadow-[0_0_12px_rgba(34,197,94,0.6)]';
    ...
    <Card className="p-6 border border-border rounded-lg shadow-lg">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <p className="text-sm font-medium text-foreground">STM32 Hub → Azure</p>
