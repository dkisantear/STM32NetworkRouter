...
## Raspberry Pi Gateway Heartbeat Testing

The dashboard includes a "Raspberry Pi Gateway → Azure" status card that shows whether the Pi is connected based on heartbeat messages.

### Testing without the Pi

You can test the gateway endpoints using curl:
